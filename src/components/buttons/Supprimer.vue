<template>
    <button @click="openOrClose" data-modal-target="popup-modal1" data-modal-toggle="popup-modal1" type="button"
        ...
        <i class="text-red-600 fa-solid fa-trash text-base"></i>
    </button>
        ...
        <div class="relative p-4 w-full max-w-md">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <button @click="effacer (props.id)" id="non" type="button"
...
const props = defineProps({
    msg: {
        type: String,
        default: "Voulez vous vraiment supprimer cet utilisateur"
    },
    id: {
        type: Number,
        required: true
...
const effacer = () => {
    ...
    emit('effacer', props.id); // Émet un événement au parent
};
