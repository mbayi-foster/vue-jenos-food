<template>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="flex justify-between items-center">
            ...
            <div>
                <router-link to="/livreurs/create" title="Ajouter un utilisateur">
                    <button type="button"
            ...
            <tbody v-if="hasData && !load">
                <tr v-for="(item, index) in paginatedData" :key="item.id" scope="row" class="px-6 py-4">
                    ...
                    <td v-for="column in columns" :key="column.key">
                        ...
                        <div class="flex items-center" v-if="column.key == 'busy'">
                            <div v-if="item['busy'] == false">
                                <div class="h-2.5 w-2.5 rounded-full bg-green-500 me-2">
                                </div>
                                Disponible
                            </div>
                           <div v-if="item['busy'] == true">
                    ...
                    <td class="text-center">
                        <div class="inline-flex rounded-md shadow-sm" role="group">
                            ...
                            <supprimer msg="Voulez vous vraiment supprimer cet utilisateur" :id="item['id']"
                                @effacer="effacer" />
