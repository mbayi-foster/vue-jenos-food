<template>
    <div class="mb-5">
        <BreadCumb hote="Notifications" lien="#" page="Notifications" :principale="true" />
    </div>
    ...
    <div v-if="erreur" class="text-center">
        ...
        <button @click="fetchItems" class="rounded-lg p-5 bg-orange-500 text-white font-bold py-2">Actualiser</button>
...
const fetchItems = async () => {
    ...
    try {
        const data = await api.get(`/notifications/${user.uid}`)
